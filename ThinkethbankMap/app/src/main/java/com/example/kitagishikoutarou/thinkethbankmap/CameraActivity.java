...
public class CameraActivity extends ActionBarActivity {
    ...
    private static final String APP_KEY = "wmlhfy4re7a76rv";
    private static final String APP_SECRET = "dt76z3xak2z7pym";
    private static final String TAG = "PhoneCamera2DBox";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (mLoggedIn) {
                    ...
                    mApi.getSession().startOAuth2Authentication(CameraActivity.this);
                }
        ...
        */
        ...
        mSwingListener.setOnSwingListener(new SwingListener.OnSwingListener() {
            public void onSwing() {
                if (mFile != null) {
                    UploadPicture upload = new UploadPicture(CameraActivity.this, mApi, PHOTO_DIR, mFile);
                    upload.execute();
